...
// -> float 0.1.23 2017-07-24 FIX
// https://github.com/RobTillaart/Arduino/issues/31 0.1.22 undo
// delayMicroseconds() for wakeups larger than 8 0.1.21 replace delay with
// delayMicroseconds() + small fix 0.1.20 Reduce footprint by using uint8_t as
// error codes. (thanks to chaveiro) 0.1.19 masking error for DHT11 - FIXED
// (thanks Richard for noticing) 0.1.18 version 1.16/17 broke the DHT11 - FIXED
