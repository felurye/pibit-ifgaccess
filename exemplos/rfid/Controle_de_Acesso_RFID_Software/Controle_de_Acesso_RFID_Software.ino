/*
   ...
   obs: Banco de dados deve estar dentro da pasta em que foi deixada o software
   do sistema
...
void setup() {
  ...
  pinMode(AtivaRFID, OUTPUT);    // Define o pino digital 10 como saída para
                                 // conectá-lo ao RFID / ATIVAR
